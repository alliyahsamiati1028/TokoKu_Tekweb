...
export default function ProductForm() {
  // Ambil fungsi & data dari context
  const { addProduct, categories, isCategoriesLoading } = useProducts();
  ...
  // Saat kategori masih loading
  if (isCategoriesLoading) {
    return <p className="text-center text-gray-500">Memuat kategori...</p>;
  }
